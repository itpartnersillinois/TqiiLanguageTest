    ...
    public class ListTestModel : PageModel {
        ...
        public async Task OnGetAsync() {
            ...
            if (_context.Tests != null) {
                Test = await _context.Tests.OrderBy(t => t.Language).ThenBy(t => t.IsPractice).ThenBy(t => t.Title).Select(t => new Test { Id = t.Id, Title = t.Title, Language = t.Language, NumberQuestions = t.NumberQuestions }).ToListAsync();
            }
        }
    }
}